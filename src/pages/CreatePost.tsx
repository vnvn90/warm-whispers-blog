        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          {previewTags.length > 0 && (
            <div className="mb-6">
              <label className="block text-sm font-medium text-foreground mb-2">
                Auto-Generated Cover Image Preview
              </label>
              <div className="overflow-hidden rounded-lg">
                <img
                  src={getCoverImage(previewTags)}
                  alt="Cover preview"
                  className="w-full h-48 object-cover blog-image"
                />
              </div>
              <p className="text-xs text-muted-foreground mt-2">
                This cover image is automatically selected based on your tags. You can override it with a custom URL below.
              </p>
            </div>
          )}
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              This will appear in the story preview cards.
            </p>
          </div>
          ...
          <div>
            ...
            />
            <p className="text-xs text-muted-foreground mt-1">
              Tags help readers find your story and determine the cover image.
            </p>
            {previewTags.length > 0 && (
          ...
          <div>
            ...
            />
            <p className="text-xs text-muted-foreground mt-1">
              Leave empty to use an auto-generated cover based on your tags.
            </p>
          </div>
